...
RUN CHART_VERSION="v1.21.4-rke2r1-build2021081601" \
...
FROM rancher/k3s:v1.21.4-k3s1 AS k3s
FROM rancher/hardened-kubernetes:v1.21.4-rke2r1-build20210816 AS kubernetes
